...
@property (nonatomic, copy) NSString * _Nullable triedAt;
...
SWIFT_CLASS("_TtC14BuzzBoosterSDK19BSTRxViewController")
@interface BSTRxViewController : UIViewController
- (void)viewDidLoad;
...
@interface BSTUIViewController : BSTRxViewController
...
///     <ol>
///       <li>
///         The <code>userId</code> should not exceed 65 characters in length.
///       </li>
///       <li>
...
/// Describes the user interface style preference within the BuzzBooster SDK context.
/// <ul>
///   <li>
///     Overview:
///     The <code>BSTUserInterfaceStyle</code> enum specifies the visual appearance of the application’s interface elements. It allows customization of the interface according to the user’s preference or system settings for light or dark mode.
///   </li>
///   <li>
///     Enum Cases:
///     <ul>
///       <li>
///         <code>system</code>: The interface style has not been set, allowing the system to choose the appearance based on the current configuration or user settings.
///       </li>
///       <li>
///         <code>light</code>: A light interface style that uses lighter colors and is intended for use in well-lit environments.
///       </li>
///       <li>
///         <code>dark</code>: A dark interface style that uses darker colors and is designed to reduce eye strain in low-light conditions.
///       </li>
///     </ul>
///   </li>
///   <li>
///     Usage:
///     Apply the <code>BSTUserInterfaceStyle</code> to adapt the application’s visual elements to the user’s preferred style.
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, BSTUserInterfaceStyle, open) {
  BSTUserInterfaceStyleSystem = 0,
  BSTUserInterfaceStyleLight = 1,
  BSTUserInterfaceStyleDark = 2,
};
...
/// A  property representing the default user interface style for the application using the BuzzBooster SDK.
/// <ul>
///   <li>
///     Overview:
///     This property sets a baseline user interface style which can be utilized throughout the application to maintain consistency in visual appearance. The default value is <code>.system</code>, allowing the application to adapt automatically to the system’s appearance settings or user’s preference.
///   </li>
///   <li>
///     Usage:
...
///     \endcode</li>
/// </ul>
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) enum BSTUserInterfaceStyle userInterfaceStyle;)
+ (enum BSTUserInterfaceStyle)userInterfaceStyle SWIFT_WARN_UNUSED_RESULT;
+ (void)setUserInterfaceStyle:(enum BSTUserInterfaceStyle)value;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
///       "price": 99.99
///     ]
///     BuzzBooster.sendEvent("user_purchase_completed", values: purchaseDetails)
///
///     \endcode</li>
/// </ul>
/// \param name A <code>String</code> representing the name of the event. This event name will be used to match against campaign
...
///     BuzzBooster.showHome(with: currentViewController)
///
///     \endcode</li>
/// </ul>
...
///     Example:
///     \code
///     let homeVC = BuzzBooster.getHomeViewController()
...
///     \code
///     let currentViewController = self // Assuming this is called within a UIViewController context
///     BuzzBooster.showCampaign(by: "campaign12345", with: currentViewController)
///
///     \endcode</li>
/// </ul>
...
///     Example:
///     \code
///     let campaignVC = BuzzBooster.getCampaignViewController(by: "campaign12345")
...
///     \code
///     let currentViewController = self // Assuming this is called within a UIViewController context
///     BuzzBooster.showCampaign(by: .discount, with: currentViewController)
///
///     \endcode</li>
/// </ul>
...
///     Example:
///     \code
///     let campaignVC = BuzzBooster.getCampaignViewController(by: .discount)
///     navigationController?.pushViewController(campaignVC, animated: true)
///
///     \endcode</li>
/// </ul>
...
///     BuzzBooster.showNaverPayExchange(with: currentViewController)
///
///     \endcode</li>
/// </ul>
...
///     \code
///     let userEventDelegate = self // Assuming this is called within a BSTUserEventDelegate context
///     BuzzBooster.removeUserEventDelegate(self)
///
///     \endcode</li>
/// </ul>
/// \param delegate An instance that conforms to the <code>BSTUserEventDelegate</code> protocol.
...
@interface CampaignBannerViewController : BSTRxViewController
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
